-- Migration 003: Evaluator Model Invocations
-- Extends the Provider-call ledger to evaluator requests while preserving
-- existing summary contexts, invocations, sources, and decision rows.

CREATE TABLE model_invocations_v3 (
  id TEXT PRIMARY KEY,
  turn_id TEXT,
  job_attempt_id TEXT,
  context_id TEXT,
...
INSERT INTO model_invocations_v3 (
...
SELECT
  rowid, id, NULL, job_attempt_id, context_id, purpose,
  NULL, NULL, NULL, call_number,
  provider, model, status, started_at, completed_at,
  tokens_input, tokens_output, tokens_total,
  response_sha256, response_bytes, error_code
...
ALTER TABLE model_invocations_v3 RENAME TO model_invocations;
...
CREATE UNIQUE INDEX idx_model_invocations_evaluator_request
  ON model_invocations(evaluator_request_id)
...
ALTER TABLE evaluator_decisions
